          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                ...
                <li>
                    <a href="testingdetails.php" class="nav-link text-left">Testing Details</a>
                </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 form-group">
                    ...
                    <input type="text" id="fname" name="fname" required="true" class="form-control form-control-lg">
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 form-group">
                    <label for="eaddress">Email Address</label>
                    <input type="text" id="eaddress" name="email" required="true" class="form-control form-control-lg">
                </div>
                <div class="col-md-6 form-group">
                    <label for="tel">Subject</label>
                    <input type="text" id="tel" name="subject" required="true" class="form-control form-control-lg">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="message">Message</label>
                    <textarea name="" id="message" name="mes" required="true" cols="30" rows="10" class="form-control"></textarea>
                </div>
            </div>

            <div class="row">
                <div class="col-12">
                    <input type="submit" value="Send Message" name="btnsubmit" class="btn btn-primary rounded-0 px-3 px-5">
                </div>
            </div>
        </div>
      </form>
...
if(isset($_POST['btnsubmit']))
{
  ...
  $sql = "insert into contact (firstname,emailadderess,subject,message) value ('$fname','$email','$subject','$mes')";
