  ...
  <section id="container">
    ...
    <!-- END services -->
      ...
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Testing Records </h3>
        <div class="row mt">
          <div class="col-lg-12">
            <div class="main-content">
                ...
                <h3 class="text-center title-2">Testing Records</h3>
                </div>
              <hr>
     <br>
...
{
	echo "<tr>";
	echo "<td>" . $row2['T_type'] . "</td>";
	echo "<td>" . $row2['P_id'] . "</td>";
	echo "<td>" . $row2['T_rollnumber'] .  "</td>";
	echo "<td>" . $row2['T_id'] . "</td>";
...
<div class="text-center">
	<button onclick="window.print()" class="btn progress-bar-info">Print</button>
</div>
</div>   
</div>             
                        </div>
